 ...
 * @returns {string}
 */
export function converter_version() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.converter_version();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./render360_spirv_wgsl_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('render360_spirv_wgsl_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
