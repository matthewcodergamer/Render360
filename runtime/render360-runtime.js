...
const CONTENT_BRIDGE={release:44,inputs:['xex','live','pirs','con'],stfsStreamingMount:true,wholePackageCopy:false,defaultXexBounded:true,translationSideEffects:false,generatedWasmExecution:true,nativeGuestThreadRegistry:true,cooperativeThreadScheduler:true,xenosTrafficInspection:true,realFrontbufferCapture:true,pauseResume:true,nativeHirCompatibilityFallback:true};
...
export class Render360Runtime extends EventTarget{
  ...
  async init(){
    ...
    void inputPromise;this.ready=true;
