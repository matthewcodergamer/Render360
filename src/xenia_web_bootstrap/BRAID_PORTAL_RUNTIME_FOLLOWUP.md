...
The full Xenia WASM32 bootstrap must rebuild and publish after these changes before device testing. Documentation-only changes to this marker are explicitly excluded from the publisher's stale-runtime source closure.
