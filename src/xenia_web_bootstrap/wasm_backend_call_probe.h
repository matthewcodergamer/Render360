...
// Mapping/protection invalidation evicts cached code. The legacy backend page
// generation below remains a cache epoch; executable-byte content generations
// are tracked separately by GetWasmBackendExecutableContentGeneration.
