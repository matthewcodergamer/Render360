...
console.log('LOW_64K_APERTURE_MAPPED=PASS');console.log('XENIA_MAIN_STACK_GEOMETRY=PASS');console.log('BRAID_70080020_STACK_ADDRESS=PASS');console.log('MAIN_THREAD_R1_VALID=PASS');console.log('MAIN_THREAD_R13_VALID=PASS');console.log('ENTRY_LOAD_ZERO_PAGE=PASS');console.log('BRAID_46C0_LOAD=PASS');console.log('XAM_028B_REACHED=PASS');console.log('BRAID_STARTUP_INTEGRATION_CRITIC=PASS');
