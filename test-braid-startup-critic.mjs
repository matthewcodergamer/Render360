...
const status=p('r360_ppc_probe_correctness_status')()>>>0;const r3=Number(BigInt.asUintN(32,p('r360_ppc_probe_correctness_r3')()))>>>0;
...
console.log('ZERO_PAGE_MAPPED=PASS');console.log('MAIN_THREAD_R1_VALID=PASS');console.log('MAIN_THREAD_R13_VALID=PASS');console.log('ENTRY_LOAD_ZERO_PAGE=PASS');console.log('XAM_028B_REACHED=PASS');console.log('BRAID_STARTUP_INTEGRATION_CRITIC=PASS');
