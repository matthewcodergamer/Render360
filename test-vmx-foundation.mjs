...
const vxr = xo => (0x10611000 + (xo << 1)) >>> 0; // Rc=0
...
const tests = [
  ...
  {name:'vadduwm-int32-modulo',op:vx(128),a:repeat(0x01020304),b:repeat(1),expect:repeat(0x01020305)},
  {name:'vsububm-int8-modulo',op:vx(1024),a:repeat(0x05050505),b:repeat(0x02020202),expect:repeat(0x03030303)},
  {name:'vsubuhm-int16-modulo',op:vx(1088),a:repeat(0x00050005),b:repeat(0x00020002),expect:repeat(0x00030003)},
  {name:'vsubuwm-int32-modulo',op:vx(1152),a:repeat(9),b:repeat(6),expect:repeat(3)},
  {name:'vand-vec128',op:vx(1028),a:repeat(0xF0F0F0F0),b:repeat(0x0F0F0F0F),expect:repeat(0)},
  {name:'vor-vec128',op:vx(1156),a:repeat(0xF0F0F0F0),b:repeat(0x0F0F0F0F),expect:repeat(0xFFFFFFFF)},
  {name:'vxor-vec128',op:vx(1220),a:repeat(0xAAAAAAAA),b:repeat(0x55555555),expect:repeat(0xFFFFFFFF)},
  {name:'vcmpequw-int32',op:vxr(134),a:repeat(0x12345678),b:repeat(0x12345678),expect:repeat(0xFFFFFFFF)},
  {name:'vslw-int32',op:vx(388),a:lanes(1,2,4,8),b:repeat(1),expect:lanes(2,4,8,16)},
  {name:'vsrw-int32',op:vx(644),a:lanes(8,16,32,64),b:repeat(1),expect:lanes(4,8,16,32)},
];
