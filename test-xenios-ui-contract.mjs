...
const patch=readFileSync('app-v42-patch.js','utf8'),ui=readFileSync('render360-xenios-ui.mjs','utf8'),css=readFileSync('ui-v44-xenios.css','utf8'),ref=readFileSync('ui-v44-xenios-v16.css','utf8'),app=readFileSync('app-v41.js','utf8');
assert.ok(patch.includes("import './render360-xenios-ui.mjs?v=44.16';"),'V44.16 UI module not live');
for(const token of ['installSystemIcons','installLibraryChrome','centerNavigation','installPerformanceHud','installStickGuides','render360:telemetry','navigator.gpu.requestAdapter','estimateRefreshRate','hudGpuName','hudResolution','hudFpsRange','ui-v44-xenios-v16.css?v=44.16','0x1008CC','0x100185','guestPresented'])assert.ok(ui.includes(token),`missing UI token: ${token}`);
