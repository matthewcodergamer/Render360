...
export class Render360Core {
  ...
  async mountStfs(file,{maxRequests=4096}={}){
    ...
    return {mounted,partial:stfs.status===3,stfs,entries,defaultXex,defaultXexKind:stfs.defaultXexKind,
      requestCount,totalBytesRead,chainComplete:stfs.status===2};
  }
